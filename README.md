...
_This webpage includes a form that takes user input and outputs a story including thier form responses. jQuery is used to assign the form inputs to variables._
